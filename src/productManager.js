...
class Product{
    ...
    constructor(id ,title, description, category, price, thumbnail, code, stock){
        this.id = id,
        this.title = title,
...
class ProductManager{
    ...
    async addProduct(newItem){
        try {
                let { title, description, category, price, status, thumbnail, code, stock } = newItem

                if (!title)         return "El campo title es obligatorio";
                if (!description)   return "El campo description es obligatorio";
                if (!category)   return "El campo category es obligatorio";
